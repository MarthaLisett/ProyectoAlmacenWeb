...
public class ControladorAgregarConsumible extends HttpServlet {
    // variables
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        consumible     = new Consumible(nombre, marca, presentacion, contenido, localizacion, disponibilidad);
       
        if(ManejoBasesDatos.insertarConsumible(consumible)) {
            url = "/exito.jsp";
        } else {
            url = "/error.jsp";
        }
