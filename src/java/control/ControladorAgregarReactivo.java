...
public class ControladorAgregarReactivo extends HttpServlet {
    // variables
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        reactivo       = new Reactivo(nombre, marca, presentacion, contenido,
                localizacion, disponibilidad);
        
        if(ManejoBasesDatos.insertarReactivo(reactivo)) {
            url = "/exito.jsp";
        } else {
            url = "/error.jsp";
        }
